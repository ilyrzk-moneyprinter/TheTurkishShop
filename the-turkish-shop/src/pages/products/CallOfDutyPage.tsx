...
const CallOfDutyPage = () => {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-dark' : 'bg-light'} transition-colors`}>
      <Helmet>
        <title>Buy Call of Duty Points - Cheap COD Points Turkey | The Turkish Shop</title>
        <meta name="description" content="Buy cheap Call of Duty Points from Turkey. Save up to 50% on COD Points. Instant delivery, secure payment. Get your CP now!" />
      </Helmet>

      {/* Hero Section */}
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-green-800 opacity-10" />
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center gap-3">
                <PlatformIcon platform="CallOfDuty" className="h-12 w-12" />
              ...
              <p className={`text-lg ${isDarkMode ? 'text-textLight/80' : 'text-textDark/80'}`}>
                Get COD Points at Turkish prices and save big on all your Call of Duty purchases. 
                Unlock operators, weapons, battle passes, and more!
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className={`${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                Access the best prices available in the Turkish region and save significantly on every purchase.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className={`${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                Receive your COD Points code immediately after payment. No waiting, no delays.
              </p>
            </motion.div>
      ...
      <div className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { step: 1, title: "Select CP Amount", desc: "Choose the amount of COD Points you want to purchase" },
              { step: 2, title: "Complete Payment", desc: "Pay securely with your preferred payment method" },
              { step: 3, title: "Receive Code", desc: "Get your COD Points code instantly via email" },
              { step: 4, title: "Redeem In-Game", desc: "Enter the code in Call of Duty to add CP to your account" }
            ].map((item) => (
              <motion.div
                key={item.step}
                initial={{ opacity: 0, x: -20 }}
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                    COD Points work across Warzone, Modern Warfare, Black Ops, and Vanguard on all platforms.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                    COD Points are shared across all platforms with your Activision account.
                  </p>
                </div>
              </div>
            </motion.div>
