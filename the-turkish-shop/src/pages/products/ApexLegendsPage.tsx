...
import { ShoppingCart, Zap, Shield, Check, AlertTriangle, Globe, ChevronDown, Star, Users, Award, Crosshair, Sparkles } from 'lucide-react';
...
const ApexLegendsPage = () => {
  ...
  const product = {
    ...
    currency: "£",
    tiers: [
      { amount: "11500", price: "14.99", bonus: null },
      { amount: "23000", price: "24.99", bonus: "9% bonus" },
      { amount: "46000", price: "44.99", bonus: "15% bonus" },
      { amount: "92000", price: "79.99", bonus: "22% bonus" },
      { amount: "124000", price: "124.99", bonus: "28% bonus" },
      { amount: "179000", price: "179.99", bonus: "Best Value" },
    ],
  };

  const handleAddToCart = (tier: any, quantity: number = 1) => {
    addToCart({
      id: `apex-coins-${tier.amount}`,
      name: product.name,
  ...
  return (
    ...
    >
      <Helmet>
        <title>Buy Apex Legends Coins - Cheap Apex Coins Turkey | The Turkish Shop</title>
        <meta name="description" content="Buy cheap Apex Legends Coins from Turkey. Save up to 60% on Apex Coins. Instant delivery, secure payment." />
      </Helmet>

      {/* Hero Section with Animated Background */}
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-red-600 via-orange-600 to-yellow-600 opacity-10" />
        <motion.div 
          animate={{ 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div variants={itemVariants} className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <PlatformIcon platform="Apex Legends" className="h-16 w-16" />
                  </motion.div>
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-sm text-gray-500">(2,103 reviews)</span>
                    </div>
                  </div>
                </div>
                ...
                <p className={`text-xl ${isDarkMode ? 'text-textLight/80' : 'text-textDark/80'}`}>
                  Get Apex Coins at Turkish prices and save up to 60% on Legends, skins, 
                  battle passes, and all your Apex Legends purchases!
                </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                    ...
                    <div>
                      <p className="font-semibold">Legendary Gear</p>
                      <p className="text-sm opacity-70">Unlock legends & skins</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-70">Get codes fast</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                    ...
                    <div>
                      <p className="font-semibold">Best Deals</p>
                ...
                <div className={`rounded-3xl ${isDarkMode ? 'bg-black/40' : 'bg-white'} backdrop-blur-xl p-8 shadow-2xl border border-white/20`}>
                  ...
                  <div className="space-y-3">
                    <motion.button
                      ...
                      className="w-full py-4 bg-gradient-to-r from-accent to-red-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-accent/50 transition-all flex items-center justify-center gap-3"
                    >
                      {purchaseLoading ? (
                    ...
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={() => handleAddToCart(product.tiers[selectedTier])}
            ...
            {[
              {
                ...
                description: "Access exclusive Turkish prices and save up to 60% on every Apex Coins purchase.",
                color: "text-blue-500"
              },
              {
                icon: Crosshair,
                title: "Unlock All Legends",
                description: "Get new Legends, legendary skins, battle passes, and exclusive event items.",
                color: "text-red-500"
              },
              {
                icon: Shield,
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { step: 1, title: "Select Coins Amount", desc: "Choose how many Apex Coins you want to purchase", icon: "💰" },
              { step: 2, title: "Secure Payment", desc: "Complete checkout with your preferred payment method", icon: "💳" },
              { step: 3, title: "Get Your Code", desc: "Receive your Apex Coins code instantly via email", icon: "📧" },
              { step: 4, title: "Redeem In-Game", desc: "Enter the code in Apex Legends store", icon: "🎮" }
            ].map((item) => (
              <motion.div
                key={item.step}
                variants={itemVariants}
              ...
              >
                <div className="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-accent to-red-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl">
                  {item.step}
                </div>
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                    These codes are for Turkish EA accounts. Make sure your EA account region is set to Turkey.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                    Apex Coins are shared across all platforms (PC, PlayStation, Xbox) on the same EA account.
                  </p>
                </div>
              </div>
            </motion.div>
