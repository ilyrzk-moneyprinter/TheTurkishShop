...
const ValorantPage = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      id: `valorant-points-${tier.amount}`,
      name: product.name,
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-dark' : 'bg-light'} transition-colors`}>
      <Helmet>
        <title>Buy Valorant Points - Cheap VP Turkey | The Turkish Shop</title>
        <meta name="description" content="Buy cheap Valorant Points (VP) from Turkey. Save up to 50% on Valorant Points. Instant delivery, secure payment. Get your VP now!" />
      </Helmet>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center gap-3">
                <PlatformIcon platform="Valorant" className="h-12 w-12" />
              ...
              <p className={`text-lg ${isDarkMode ? 'text-textLight/80' : 'text-textDark/80'}`}>
                Get VP at Turkish prices and save up to 50% on all your Valorant purchases. 
                Unlock agents, skins, battle passes, and more!
              </p>
      ...
      <div className={`py-16 px-6 ${isDarkMode ? 'bg-black/10' : 'bg-gray-50'}`}>
        <div className="max-w-6xl mx-auto">
          <h2 className={`text-3xl font-bold text-center mb-12 ${isDarkMode ? 'text-textLight' : 'text-textDark'}`}>
            Why Buy Valorant Points from Us?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className={`${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                Receive your VP code immediately after payment. No waiting, no delays.
              </p>
            </motion.div>
      ...
      <div className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { step: 1, title: "Select VP Amount", desc: "Choose the amount of Valorant Points you want to purchase" },
              { step: 2, title: "Complete Payment", desc: "Pay securely with your preferred payment method" },
              { step: 3, title: "Receive Code", desc: "Get your VP code instantly via email" },
              { step: 4, title: "Redeem In-Game", desc: "Enter the code in Valorant to add VP to your account" }
            ].map((item) => (
              <motion.div
                key={item.step}
                initial={{ opacity: 0, x: -20 }}
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                    These codes are for Turkish region accounts. Make sure your Valorant account is set to Turkey region.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className={`text-sm ${isDarkMode ? 'text-textLight/70' : 'text-textDark/70'}`}>
                    VP codes are delivered instantly to your email after successful payment.
                  </p>
                </div>
              </div>
            </motion.div>
