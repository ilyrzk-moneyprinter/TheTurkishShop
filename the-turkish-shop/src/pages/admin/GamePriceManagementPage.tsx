...
// Simple AdminLayout component since the original might not exist
          ...
          <div className="overflow-x-auto">
            <table className={`min-w-full divide-y ${isDarkMode ? 'divide-gray-700' : 'divide-gray-200'}`}>
              ...
              <tbody className={`${isDarkMode ? 'bg-gray-800 divide-y divide-gray-700' : 'bg-white divide-y divide-gray-200'}`}>
                {isLoading ? (
                  <tr>
                    <td colSpan={8} className={`px-6 py-4 text-center ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>
                  ...
                  filteredGamePrices.map((game, index) => (
                    <tr key={index} className={`${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                        <a
                          ...
                          className="text-accent hover:text-accent-hover flex items-center justify-end"
                        >
